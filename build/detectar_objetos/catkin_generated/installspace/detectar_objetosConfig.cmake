...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'detectar_objetos' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/champion/catkin_ws/install/${idir}'.  Ask the maintainer 'champion <champion@todo.todo>' to fix it.")
    endif()
