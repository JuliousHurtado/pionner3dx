...
(cl:defmethod cl:initialize-instance :after ((m <Punto>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Punto)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_code-msg:<Punto> is deprecated: use common_code-msg:Punto instead.")))
...
(cl:defmethod x-val ((m <Punto>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_code-msg:x-val is deprecated.  Use common_code-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Punto>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_code-msg:y-val is deprecated.  Use common_code-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'angulo_pan-val :lambda-list '(m))
(cl:defmethod angulo_pan-val ((m <Punto>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_code-msg:angulo_pan-val is deprecated.  Use common_code-msg:angulo_pan instead.")
  (angulo_pan m))

(cl:ensure-generic-function 'angulo_tilt-val :lambda-list '(m))
(cl:defmethod angulo_tilt-val ((m <Punto>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_code-msg:angulo_tilt-val is deprecated.  Use common_code-msg:angulo_tilt instead.")
  (angulo_tilt m))

(cl:ensure-generic-function 'tiempo-val :lambda-list '(m))
(cl:defmethod tiempo-val ((m <Punto>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_code-msg:tiempo-val is deprecated.  Use common_code-msg:tiempo instead.")
  (tiempo m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Punto>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'y))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'angulo_pan))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'angulo_tilt))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Punto>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'angulo_pan) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
