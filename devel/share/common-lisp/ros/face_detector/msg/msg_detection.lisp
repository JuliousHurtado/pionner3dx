...
(cl:defmethod cl:initialize-instance :after ((m <msg_detection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'msg_detection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name face_detector-msg:<msg_detection> is deprecated: use face_detector-msg:msg_detection instead.")))
...
(cl:defmethod timestamp-val ((m <msg_detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detector-msg:timestamp-val is deprecated.  Use face_detector-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'delta_x-val :lambda-list '(m))
(cl:defmethod delta_x-val ((m <msg_detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detector-msg:delta_x-val is deprecated.  Use face_detector-msg:delta_x instead.")
  (delta_x m))

(cl:ensure-generic-function 'obj_x_y-val :lambda-list '(m))
(cl:defmethod obj_x_y-val ((m <msg_detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detector-msg:obj_x_y-val is deprecated.  Use face_detector-msg:obj_x_y instead.")
  (obj_x_y m))

(cl:ensure-generic-function 'obj_orient-val :lambda-list '(m))
(cl:defmethod obj_orient-val ((m <msg_detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detector-msg:obj_orient-val is deprecated.  Use face_detector-msg:obj_orient instead.")
  (obj_orient m))

(cl:ensure-generic-function 'robot_x_y-val :lambda-list '(m))
(cl:defmethod robot_x_y-val ((m <msg_detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detector-msg:robot_x_y-val is deprecated.  Use face_detector-msg:robot_x_y instead.")
  (robot_x_y m))

(cl:ensure-generic-function 'robot_orient-val :lambda-list '(m))
(cl:defmethod robot_orient-val ((m <msg_detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detector-msg:robot_orient-val is deprecated.  Use face_detector-msg:robot_orient instead.")
  (robot_orient m))

(cl:ensure-generic-function 'n_type-val :lambda-list '(m))
(cl:defmethod n_type-val ((m <msg_detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detector-msg:n_type-val is deprecated.  Use face_detector-msg:n_type instead.")
  (n_type m))

(cl:ensure-generic-function 'scores-val :lambda-list '(m))
(cl:defmethod scores-val ((m <msg_detection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader face_detector-msg:scores-val is deprecated.  Use face_detector-msg:scores instead.")
  (scores m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<msg_detection>)))
  ...
  "4e1b41aa48cb160e3a12fbe4c080a043")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'msg_detection)))
  "Returns md5sum for a message object of type 'msg_detection"
  "4e1b41aa48cb160e3a12fbe4c080a043")
