"""autogenerated by genpy from face_detector/msg_detection.msg. Do not edit."""
import sys
...
class msg_detection(genpy.Message):
  _md5sum = "4e1b41aa48cb160e3a12fbe4c080a043"
  _type = "face_detector/msg_detection"
...
"""
  __slots__ = ['header','timestamp','delta_x','obj_x_y','obj_orient','robot_x_y','robot_orient','n_type','scores']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,timestamp,delta_x,obj_x_y,obj_orient,robot_x_y,robot_orient,n_type,scores
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2d.pack(_x.timestamp, _x.delta_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timestamp, _x.delta_x,) = _struct_2d.unpack(str[start:end])
      start = end
      end += 16
